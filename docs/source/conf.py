...
htmlhelp_basename = 'aligned-hierarchies'
...
latex_documents = [
  ('index', 'aligned-hierarchies.tex', u'ah Documentation',
...
texinfo_documents = [
  ('index', 'ah', u'ah Documentation',
   u'Read the Docs', 'ah', 'One line description of project.',
   'Miscellaneous'),
]
